  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 max-w-screen-2xl items-center justify-between">
        <Link href="/" className="flex items-center gap-2" aria-label="DropShipKit Home">
          <Store className="h-7 w-7 text-primary" />
          <span className="font-headline text-xl font-bold text-primary">DropShipKit</span>
        </Link>
          ...
          <Sheet>
            ...
            <SheetContent side="right" className="w-[280px] sm:w-[320px]">
              ...
              <Link href="/" className="flex items-center gap-2 mb-4" aria-label="DropShipKit Home">
                ...
                <Button asChild variant="outline" className="py-3 text-base">
                  <Link href="#">Login</Link>
                </Button>
              </nav>
            </SheetContent>
